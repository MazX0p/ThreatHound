# total hours i speend here : 18322.1
...
if __name__ == '__main__':
    ...
    if args.form == True:
        ...
        if sigma_path != None and len(sigma_path) > 0:
            if os.path.exists(sigma_path) and os.path.isdir(sigma_path):
                SigmaPath = sigma_path
            else:
                print_colored("[-] error: sigma path is incorrect.", Fore.RED)
                sys.exit(1)

        GetRuleFilesList(SigmaPath)
